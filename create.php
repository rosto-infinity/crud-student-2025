...
// Récupération et nettoyage des données
   ...
   if (empty($password_student)) {
        $errors['password_student'] = "Le mot de passe est obligatoire";
    } elseif (strlen($password_student) < 8) {
 ...
 // Si aucune erreur, insert database
    ...
    <div class="form-container">
        ...
        <form action='' method="POST">
            <div class="form-group">
                ...
                value="<?= isset($nom_student) ? $nom_student : ''  ?>"
            ...
            <div class="form-group">
                ...
                value="<?= isset($email_student) ? $email_student : ''  ?>"
